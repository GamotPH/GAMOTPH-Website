...
const ArticleDetail = () => {
  ...
  useEffect(() => {
    ...
    client.fetch(query, { slug: decodedSlug }).then(setArticle).catch(console.error);
  }, [slug]);
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 md:px-12 py-10 max-w-4xl mx-auto">
        ...
        <p className="text-gray-500 text-sm mb-6">{new Date(article.date).toDateString()}</p>

        <div className="prose prose-lg text-justify max-w-full">
          <PortableText

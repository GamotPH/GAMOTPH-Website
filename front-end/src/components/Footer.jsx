    ...
    <footer className="px-4 divide-y bg-gray-900 text-white">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <Link onClick={scrollToTop} to="/">
          <img className="cursor-pointer h-[2rem] md:h-[3rem] w-auto z-20" src={logo} alt="PCSMA Logo" />
        </Link>
        </div>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <Link onClick={scrollToTop} className="text-gray-100 hover:text-gray-300" to="/">Home</Link>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <Link onClick={scrollToTop} className="text-gray-100 hover:text-gray-300" to="/contactUs">Contact Us</Link>
              </li>
            </ul>
          </div>
